...
class GridWorld_Nash1_Player0_Agent(non_RL_Agent):
    """
    A Specific Agent class that plays a Nash equilibrium strategy (as opponent aka playerID=1) for GridWorld Game
    """

    def __init__(self,game,playerID=0):
        super(GridWorld_Nash1_Player0_Agent,self).__init__(game,playerID)
